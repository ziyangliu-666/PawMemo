...
export type ConversationSessionStatus = "active" | "ended";

export type ConversationSpeaker = "user" | "assistant" | "system";
...
export interface PendingConversationActionRecord {
  id: number;
  sessionId: number;
  actionKind: string;
  payloadJson: string;
